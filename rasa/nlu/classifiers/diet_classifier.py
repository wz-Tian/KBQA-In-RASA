...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        # print(model_data)
        # print(model_data.data['entities'])
        # print(model_data.label_key)
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        if self.component_config[INTENT_CLASSIFICATION]:
            ...
            #     print('label_ranking ' + str(key) + " : " + str(label[key]))
        if self.component_config[ENTITY_RECOGNITION]:
            ...
            #         print('entity ' + str(key) + " : " + str(entity[key]))
        if out and DIAGNOSTIC_DATA in out:
            message.add_diagnostic_data(self.unique_name, out.get(DIAGNOSTIC_DATA))
            # for key in out.get(DIAGNOSTIC_DATA).keys():
            #     print(str(key) + " : "  + str(out.get(DIAGNOSTIC_DATA)[key]))
